...
export const experienceIntro =
  "Across consulting, investing, and operations roles, I keep coming back to the same thread: using analysis to drive better business and financial decisions.";

export const roles: Role[] = [
  {
    role: "IT & AI Consulting Intern",
    ...
    bullets: [
      ...
      "Authored the project brief, user stories, and dashboard design approved by ownership.",
    ],
  },
  {
  ...
  {
    role: "Assistant Business Controller / Buyer",
    org: "Redtail Golf Center · Portland, OR",
    date: "Jan 2024 – Aug 2025",
    column: 1,
    logo: "/images/logos/redtail.svg",
    bullets: [
  ...
  {
    role: "Academy Analyst",
    org: "USC Global Investment Society",
    date: "Jan 2026 – May 2026",
    column: 2,
    logo: "/images/logos/usc-gis.svg",
    bullets: [
  ...
  {
    role: "Finance Team Consultant",
    org: "Marshall Artificial Intelligence Association",
    date: "Jan 2026 – Present",
    column: 2,
    logo: "/images/logos/maia.svg",
    bullets: [
